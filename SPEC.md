...
Status: **MVP locked; post-MVP roadmap approved.** Sections 1–11 are the implementation-ready MVP specification produced by the wayfinder map ([#1](https://github.com/nvergez/orca-viz/issues/1)). Section 12 adds the approved quantitative post-mortem roadmap from [#52](https://github.com/nvergez/orca-viz/issues/52) without reopening the MVP's read-only or render-what-parses invariants.
